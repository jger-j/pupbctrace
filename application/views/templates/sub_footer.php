...
<footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2018 <a href="#">Adarlo - Espiritu - Mendeja - Verzosa</a>.</strong> All rights reserved.
</footer>
<!-- Control Sidebar -->
<aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="control-sidebar-home-tab">
            ...
            <ul class="control-sidebar-menu">
                <li>
                    <a href="javascript:;">
                        ...
                        <div class="menu-info">
                            <h4 class="control-sidebar-subheading">Pre-Oral Defense</h4>

                            <p>Will be First Week of September</p>
                        </div>
                    </a>
                </li>
            </ul>
            ...
            <h3 class="control-sidebar-heading">System Development Progress</h3>
            <ul class="control-sidebar-menu">
                <li>
                    <a href="javascript:;">
